...
```html
<div style="font-family:Inter,-apple-system,sans-serif;max-width:560px;margin:0 auto;color:#0d0d0d;line-height:1.65;">

  <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.85rem;font-weight:600;color:#0d0d0d;border-left:3px solid #8b2252;padding-left:14px;margin:0 0 18px;">Si vnútri.</h2>
  ...
  <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:600;color:#8b2252;margin:28px 0 10px;">Ako to bude prebiehať</h3>
  ...
  <p style="font-size:0.96rem;margin:24px 0 14px;">Tešíme sa.<br>
  ...
  <p style="font-size:0.78rem;color:#6b5540;line-height:1.55;margin:0;">
    <strong>Pridaj si event do kalendára:</strong>
    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=%C4%8CS+Dating+Wien+%E2%80%94+Ed%C3%ADcia+I&dates=20260622T173000Z%2F20260622T193000Z&location=Wien+1.+okres&details=ČS+Dating+Wien+%E2%80%94+detaily+v+emaile" style="color:#8b2252;">Google Calendar</a> &nbsp;·&nbsp;
    Apple Calendar (.ics príloha)
  </p>
...
## ⚠️ BLOCKER — placeholders to fill before sending

Replace BEFORE you send the first one:
- `[VENUE NAME]` → e.g., `Wein & Co Stephansplatz`
- `[ADRESA]` → e.g., `Jasomirgottstraße 3-5, 1010 Wien`
- `[U-Bahn/tram info]` → e.g., `U1/U3 Stephansplatz, 2 min pešo`

Once you have these three things, this email is shippable.
